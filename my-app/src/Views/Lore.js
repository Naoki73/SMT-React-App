...
import DemonLore from '../components/DemonLore';
...
export default class Lore extends Component {
  ...
  showDemons = () => {
    return this.state.demons.map(p =><DemonLore key={p.id} demonInfo={p} catchDemons={this.catchDemons} user={this.props.user} />
